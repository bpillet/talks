...
E \to E** counité d'une adjonction donc élément universel parmis les transformations naturelles id -> bidual
...
Exemple catégorie qui n'est pas (co-)complète : Catégorie des corps. Un produit infini n'est pas forcément un corps.
