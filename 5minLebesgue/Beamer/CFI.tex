...
\begin{center}\large
\only<1>{\parbox{.7\textwidth}{Que ce passe-t-il si on multiplie toutes les dimensions de l'objet $1$ par $\lambda_1 \in \R^{+*}$ ainsi que sa distance à l'observateur ?}}
\nota{Rien ne change}
...
\nota{En regroupant tout ça, on va montrer que c'est absurde}
\begin{center}
\begin{align*}
