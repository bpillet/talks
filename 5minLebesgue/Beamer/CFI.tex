...
\note{Après découpage, le point $A$ se dédouble : une copie $A_{12}$ dans $U_1$ et une copie $A_{21}$ dans $U_2$}
\includegraphics<2>[scale=.4]{../Images/Aij.pdf}
\end{center}
\end{frame}
...
\includegraphics<2>[scale=.4]{../Images/1Loin2Pres.pdf}
\end{center}
\end{frame}
...
\begin{equation*}
d_{12} = \dfrac{\text{ distance du point }A_{12}\text{ à l'observateur}}{\text{ distance du point }A_{21}\text{ à l'observateur}}
\end{equation*}
\end{frame}
