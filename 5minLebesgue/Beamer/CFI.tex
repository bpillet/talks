\documentclass[14pt,xcolor=dvipsnames]{beamer}% version imprimable avec notes d’orateur, handout
...
\begin{frame}% Dij
\nota{
Pour garder cette information en mémoire, on va noter $d_{12}$ le rapport des distances à l'observateur de ces deux points.
}
\begin{equation*}
...
\hspace*{-5em}\includegraphics<1>[scale=.87]{../Images/lego-triangle.jpg}
\end{center}
\end{frame}
